...
# CUDA_VISIBLE_DEVICES=3 TAG=INT8model-STE-QAT-LoRA MODEL=meta-llama/Meta-Llama-3-8B TASK=ReCoRD WBIT=8 ABIT=8 GBIT=8 BS=2 MODE=lora LR=1e-5 PEFTMODE=lora TRAINER=regular bash finetune_ste.sh --num_train 1000 --num_dev 500 --num_eval 1000 --train_set_seed 0
# CUDA_VISIBLE_DEVICES=3 TAG=INT8model-STE-QAT-LoRA MODEL=meta-llama/Meta-Llama-3-8B TASK=SQuAD WBIT=8 ABIT=8 GBIT=8 BS=2 MODE=lora LR=3e-5 PEFTMODE=lora TRAINER=regular bash finetune_ste.sh --num_train 1000 --num_dev 500 --num_eval 1000 --train_set_seed 0
# CUDA_VISIBLE_DEVICES=3 TAG=INT8model-STE-QAT-LoRA MODEL=meta-llama/Meta-Llama-3-8B TASK=DROP WBIT=8 ABIT=8 GBIT=8 BS=1 MODE=lora LR=1e-5 PEFTMODE=lora TRAINER=regular bash finetune_ste.sh --num_train 1000 --num_dev 500 --num_eval 1000 --train_set_seed 0
# CUDA_VISIBLE_DEVICES=3 TAG=INT8model-STE-QAT-LoRA MODEL=meta-llama/Meta-Llama-3-8B TASK=MultiRC WBIT=8 ABIT=8 GBIT=8 BS=2 MODE=lora LR=5e-5 PEFTMODE=lora TRAINER=regular bash finetune_ste.sh --num_train 1000 --num_dev 500 --num_eval 1000 --train_set_seed 0

# Evaluation of trained models
echo "Evaluating trained models..."

# # Evaluate ReCoRD
# CUDA_VISIBLE_DEVICES=3 TAG=INT8model-STE-QAT-LoRA MODEL=meta-llama/Meta-Llama-3-8B TASK=ReCoRD WBIT=8 ABIT=8 GBIT=8 NUM_TRAIN=1 NUM_EVAL=1000 TRAIN_SET_SEED=0 bash script/eval_ste_simple.sh

# # Evaluate SQuAD
CUDA_VISIBLE_DEVICES=3 TAG=INT8model-STE-QAT-LoRA MODEL=meta-llama/Meta-Llama-3-8B TASK=SQuAD WBIT=8 ABIT=8 GBIT=8 NUM_TRAIN=1 NUM_EVAL=1000 TRAIN_SET_SEED=0 bash script/eval_ste_simple.sh
