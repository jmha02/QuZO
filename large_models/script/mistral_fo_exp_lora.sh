...
CUDA_VISIBLE_DEVICES=3 TAG=INT4model-FO-QAT-LoRA MODEL=mistralai/Mistral-7B-Instruct-v0.3 TASK=ReCoRD WBIT=4 ABIT=8 BS=2 MODE=lora LR=1e-5 bash finetune.sh 
CUDA_VISIBLE_DEVICES=3 TAG=INT4model-FO-QAT-LoRA MODEL=mistralai/Mistral-7B-Instruct-v0.3 TASK=SQuAD WBIT=4 ABIT=8 BS=2 MODE=lora LR=3e-5 bash finetune.sh 
CUDA_VISIBLE_DEVICES=3 TAG=INT4model-FO-QAT-LoRA MODEL=mistralai/Mistral-7B-Instruct-v0.3 TASK=DROP WBIT=4 ABIT=8 BS=1 MODE=lora LR=1e-5 bash finetune.sh 
CUDA_VISIBLE_DEVICES=3 TAG=INT4model-FO-QAT-LoRA MODEL=mistralai/Mistral-7B-Instruct-v0.3 TASK=MultiRC WBIT=4 ABIT=8 BS=2 MODE=lora LR=5e-5 bash finetune.sh 
