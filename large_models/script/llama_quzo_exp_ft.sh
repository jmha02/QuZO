...
# CUDA_VISIBLE_DEVICES=2 TAG=QuZO-LPmodel-QFT-SST2-Ours MODEL=meta-llama/Llama-2-7b-hf TASK=SST2 WBIT=4 PBIT=4 MODE=qft BS=8 LR=2e-6 EPS=2e-3 TRAINER=zo_lowbit_ft TWO=True STEPS=6000 bash quzo.sh 
CUDA_VISIBLE_DEVICES=2 TAG=QuZO-LPmodel-QFT-SST2-Ours MODEL=meta-llama/Llama-2-7b-hf TASK=SST2 WBIT=4 PBIT=4 MODE=qft BS=16 LR=1e-6 EPS=1e-3 TRAINER=zo_lowbit_ft TWO=True STEPS=6000 bash quzo.sh 
